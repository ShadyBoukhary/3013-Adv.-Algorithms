...
// Recieves a string to be used as akey

// Searches for the key in the tree

// returns the type of the word found, or empty string if not found

//************************************************************************
string BSTree::search(string word) {
	node *nodePtr = root;
